...
async def date_button(update, context):
	...
	await send_html(update, context, "Отличный выбор! Пригласите девушку (парня) на свидание за 5 сообщений")
	promt = load_prompt(query)
...
app = ApplicationBuilder().token("8089586853:AAHr0B2TuVgLcobE6cIEA58W6ds74aOYI6w").build()
